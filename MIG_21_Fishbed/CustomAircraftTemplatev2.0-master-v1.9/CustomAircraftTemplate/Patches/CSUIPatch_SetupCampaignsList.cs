...
using CustomAircraftTemplateMIG21.Patches.TranspilerStuff;
using Harmony;
using Harmony.Extensions.CustomAircraftTemplateMIG21;
using RewiredConsts;
using UnityEngine;

namespace CustomAircraftTemplateMIG21.Patches.CampaignStuff
{
    [HarmonyPatch]
